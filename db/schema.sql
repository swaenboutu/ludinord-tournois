...
-- ---------- Joueurs ----------
-- Pseudo public + contact facultatif visible admin uniquement.
-- Le filtrage "admin only" du contact se fait côté application, pas en base.
...
CREATE TABLE pool_rounds (
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uq_pool_rounds_order (round_order),
...
--  - Départage de poule (parties gagnées, 2es places...) et score d'équipe
--    solo (somme des 2 membres) : calculés côté app, dérivés de party_results.
-- =====================================================================
